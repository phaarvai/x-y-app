  ...
  return (
    <div className="min-h-screen bg-[#F8FAFF] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12">
        ...
        <p className="text-gray-500 text-center mb-8 max-w-sm">Your manufacturing slot has been booked. A confirmation has been sent to your email.</p>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm w-full max-w-md overflow-hidden">
          <div className="bg-blue-600 text-white p-5">
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="font-mono font-bold text-sm tracking-wider flex items-center gap-1.5"><Hash className="w-3.5 h-3.5" />{CONFIRMATION_ID}</span>
            </div>
          ...
          <div className="p-5 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div><p className="text-xs text-gray-400">Date</p><p className="font-medium text-gray-900 text-sm">{date}</p></div>
            </div>
            <div className="flex items-start gap-3">
              <Clock className="w-4 h-4 text-gray-400 mt-0.5 shrink-0" />
              <div><p className="text-xs text-gray-400">Selected Slots</p><p className="font-medium text-gray-900 text-sm">{slots}</p></div>
            </div>
            <div className="flex items-start gap-3">
              <MapPin className="w-4 h-4 text-gray-400 mt-0.5 shrink-0" />
              <div><p className="text-xs text-gray-400">Location</p><p className="font-medium text-gray-900 text-sm">{locationStr}</p></div>
            </div>
          ...
          <div className="px-5 pb-5 space-y-2">
            <Button variant="outline" className="w-full border-gray-200 text-gray-700 gap-2"><Download className="w-4 h-4" /> Download Receipt</Button>
          </div>
        </div>
        ...
        <div className="mt-6 flex gap-3">
          <Link href="/browse"><Button variant="outline" className="border-gray-200 text-gray-700">Browse More Manufacturers</Button></Link>
          <Link href="/ai-assistant">
            <Button className="bg-blue-600 hover:bg-blue-700 text-white gap-1.5">Plan Another Product <ArrowRight className="w-4 h-4" /></Button>
          </Link>
        </div>
      </div>
    </div>
